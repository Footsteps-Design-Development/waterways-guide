...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		...
		function validateCoupon(box){
			...
			if(coupon){
				...
				//change coupon enrty to validated
...
?>				default:
	...
	<tr><td class=profile_label><?php echo($servicetitle); ?></td><td class=profile_field valign="top"><?php echo($boxes); ?><div id="discount_message"></div></td></tr>			
		...
		<td class=profile_field> <input class=formcontrol type='text' name='Email' size='30' value="<?php echo($Email); ?>">  
			<input type='hidden' name='couponvalidated' value='0'><span id='couponvalidate'>
			<?php
		if($ID=="new"){

			echo(" Coupon code <input id='coupon' name='coupon' type='text' size='14' maxlength='13'>
				<span class='btn btn-info' onclick='validateCoupon()'>Validate</span>");
