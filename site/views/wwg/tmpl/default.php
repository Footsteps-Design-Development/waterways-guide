...
$parentlink = Route::_('index.php?Itemid=' . $currentMenuItem->parent_id);
...
<form name="form" enctype="multipart/form-data" method="post">
    <table width="100%" border="0" cellpadding="3" cellspacing="1">
        ...
        $test_vars = [
            'country', 'country_tmp', 'waterway', 'waterway_tmp', 'guidetable', 'guideid',
            'guideno', 'guideaction', 'lastguideaction', 'infoid', 'GuideMooringCodes',
            'GuideHazardCodes', 'filteroption', 'editpage', 'message', 'filter', 'positionaction',
            'thisid', 'Status0', 'Status1', 'Status2', 'thiscountry', 'outputlistresults',
            'section', 'num_rows', 'GuideRatingIcon', 'sections', 'where', 'filterwhere', 'CatHelp',
            'GuideName', 'GuideRating0', 'GuideRating1', 'GuideRating2', 'GuideRating3',
            'GuideRating4', 'GuideRef', 'GuideLocation', 'info', 'errmsg', 'status', 'listresults',
            'ChangeGuideName', 'ChangeGuideCategoryDesc', 'ChangeGuideOrder', 'ChangeGuideRating',
            'ChangeGuideLat', 'ChangeGuideLong', 'ChangeGuideRef', 'ChangeGuideLocation',
            'ChangeGuideMooring', 'ChangeGuideFacilities', 'ChangeGuideCosts', 'ChangeGuideAmenities',
            'ChangeGuideContributors', 'ChangeGuideSummary', 'ChangeGuideRemarks', 'submitteremail',
            'submitterid', 'GuideCountry', 'GuideWaterway', 'GuideVer', 'GuideStatus',
            'GuideEditorMemNo', 'GuideCategory', 'GuideCategoryDesc', 'GuideOrder', 'GuideRating',
            'GuideLatLong', 'GuideLat', 'GuideLong', 'boxes', 'boxestitle', 'GuideContributors',
            'GuideSummary', 'GuideRemarks', 'GuidePostingDate', 'GuideUpdatedisplay', 'GuideCodes',
            'GuideNo', 'GuideMooring', 'GuideFacilities', 'GuideCosts', 'GuideAmenities',
            'GuideDocs', 'footermooringsguide', 'guiderequestmethod', 'GuideMessage', 'menu',
            'admin'
        ];
        ...
        if (in_array($guideaction, ["map", "map_edit", "memberedit", "edit", "positionaction"])) {
        ?>
            <!-- Add any map-specific content here -->
        <?php
        }
        ...
        if (in_array($guideaction, ["approvesubmission", "rejectsubmission"])) {
        ...
        //---------------------------------------List countries---------------------------------------------
        if (in_array($guideaction, ["", "waterways", "tick_filter", "savepdflist", "adminreports"])) {
...
if (in_array($guideaction, ["memberedit", "edit"])) {
