...
<tr><td class=content_introduction><b>Member update</b><br />
Thank you for helping to keep the guide uptodate by sending us any additions or amendments you come across on your cruise. GPS positions  would be particularly welcome to enable more locations to be displayed on the guide maps<br />Enter your changes in the appropriate boxes adding or deleting data as necessary.<br />On completion click 'Send' - your contribution will be on its way to our editor.</td></tr>
<tr><td class='bodytext'><input type="button" class="btn btn-primary" value="Back to the list" onClick="document.form.guideaction.value='list';document.form.submit()"><input type="button" class="btn btn-primary" value="Back to the map" onClick="document.form.guideaction.value='map';document.form.submit()"></td></tr>
...
?>		 
<tr valign='top'><td><b>Name:</b> <i>Town or locality name [50] </i></td></tr><tr valign='top'><td class=mooring_edit_underline><input name="GuideName" type="text" class="formcontrol" value="<?php echo($GuideName); ?>" size="50" maxlength="50" /></td></tr>
<tr valign='top'><td><b>Rating:</b> <i>Overall impression;</i></td></tr><tr valign='top'><td class=mooring_edit_underline>
<?php
...
<tr valign='top'>
  <td><b>Reference:</b> <i>PK/km/MP Number if known</i></td></tr><tr valign='top'><td class=mooring_edit_underline><input type="text" name="GuideRef" class="formcontrol" size="50" maxlength="50" value="<?php echo($GuideRef); ?>"></td></tr>
<tr valign='top'><td><b>Location:</b> <i>A description of the location of the mooring place sufficient for the user to find it with confidence. Include which bank and if possible a reference to conspicuous features such as a bridge or lock</i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideLocation" class="formtextarea"><?php echo($GuideLocation); ?></textarea></td></tr>
...
<tr valign='top'><td><b>Mooring:</b> <i>A description of the mooring itself - e.g. length and nature of quay, securing arrangements, water depth, any limitations, contact details of administration etc.</i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideMooring" class="formtextarea"><?php echo($GuideMooring); ?></textarea></td></tr>
<tr valign='top'><td>
<?php 
	//add tick boxes here
...
<tr valign='top'><td><b>Facilities:</b> <i>Add some more about the ticked facilities or additional info not covered in the ticks</i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideFacilities" class="formtextarea"><?php echo($GuideFacilities); ?></textarea></td></tr>


<tr valign='top'><td><b>Costs:</b> <i>Indicative costs - typically daily related to length or bracket of lengths plus costs of use of facilities</i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideCosts" class="formtextarea"><?php echo($GuideCosts); ?></textarea></td></tr>
<tr valign='top'><td><b>Amenities:</b> <i>Amenities available in the nearest town or village with distances - shops, cafes, railway etc etc </i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideAmenities" class="formtextarea"><?php echo($GuideAmenities); ?></textarea></td></tr>

<tr valign='top'><td><b>Contributors:</b> <i>Boat name, length x draft, date of contribution(M/YY)</i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideContributors" class="formtextarea"><?php echo($GuideContributors); ?></textarea></td></tr>
<tr valign='top'><td><b>Remarks:</b> <i>Any general comments, recommendations or opinions!</i></td></tr><tr valign='top'><td class=mooring_edit_underline><textarea cols="120" rows="5" name="GuideRemarks" class="formtextarea"><?php echo($GuideRemarks); ?></textarea></td></tr>
<tr valign='top'>
  <td><b>Summary:</b> <i>This is the basis for the summary of the <U>whole waterway</U> that appears as the header to each guide. Please check this and if you have any changes or   additions edit the Summary box in the <U>first mooring of this waterway</U></i> </td></tr><tr valign='top'><td class=mooring_edit_underline>
<textarea cols="120" rows="5" name="GuideSummary" class="formtextarea"><?php echo($GuideSummary); ?></textarea></td></tr>
<tr valign='top'>
  <td><b>Last update: </b><?php echo($GuideUpdatedisplay); ?></td></tr>
<?php
if($infoid=="new"){
