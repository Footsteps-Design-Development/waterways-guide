...
if ($status=="submitted"){
	...
	<td class=list_small><b>Initials</b></td>
	...
	<td class=list_small><b>SecondInitials</b></td>
	...
	<td class=list_small><b>TelephoneNo</b></td>
	...
	<td class=list_small><b>Login</b></td>
	...
	while($emailno<=$maxmembers){
		...
		$file.="</td><td class=list_small>".$row["Initials"];
		...
		$file.="</td><td class=list_small>".$row["Initials2"];
		...
		$file.="'</td><td class=list_small>".$row["Telephone1"];
		$file.="</td><td class=list_small>".$row["Address1"];
		$file.="</td><td class=list_small>".$row["Address2"];
		$file.="</td><td class=list_small>".$row["Address3"];
		$file.="</td><td class=list_small>".$row["Address4"];
		$file.="</td><td class=list_small>".$row["PostCode"];
		...
		$file.="</td><td class=list_small>".$row["MemStatus"];
		$file.="</td><td class=list_small>".$row["Login"];
