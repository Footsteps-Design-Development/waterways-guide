...
//page shortcuts
$contactpage="http://www.barges.org/homepage/contacts";
$eventsurl="http://www.barges.org/events";
$memberloginurl="http://www.barges.org/login";
$registerurl="http://www.barges.org/join";
$paypalreturn="http://www.barges.org/ppreturn.php";
$paypalthanks="http://www.barges.org/index.php";
$paypalcancel="http://www.barges.org/index.php";
...
$footerassetcontactemail="DBA - The Barge Association - www.barges.org - This email has been sent to you from a member responding to your offer of help relating to the vessel asset register via the secure Members section of the website. 
...
shared with the DBA for the sole use of its members. Copyright rests 
with the DBA and must be respected. Copyright &copy; ".date("Y ").$sitename;
...
\n\nFor other enquiries relating to guides and to report updates please contact guideseditor@barges.org.
\n\nThe Guide has been compiled from contributions by DBA members. Please assist in keeping it up to date by sending amendments or additions to the editor at guideseditor@barges.org.";
...
Please assist us in keeping the guide relevant and useful by sending us any additions or amendments you come across on your cruise. GPS positions (in decimal degrees if possible) would be particularly welcome to enable more locations to be displayed on the guide maps.\n
You may do this on-line following the instructions on the welcome page of the waterways Guide section of the DBA website. \n
...
And if yours is a minor or urgent amendment just send a simple text email to the editor at guideseditor@barges.org  identifying the waterway, location  name and PK number and describing your proposed change. This is most useful if you wish to contribute whilst actually cruising.
\n\nThank you in anticipation!.\n\n";


$mooringsguidesectionintrotext="<p>Select a <em>Country</em> from the dropdown above, then select <em>All</em> or a single <em>Waterway</em>. &nbsp;You can use the Filter tick-boxes to narrow the search, e.g., to find a location with water. &nbsp;You then have options to&nbsp;</p>
<p>1 View a <strong>List</strong> of the selected locations<br /> 2 Download&nbsp;the information in a&nbsp;<strong>PDF</strong> file for saving or printing<br /> 3 Download the&nbsp;information&nbsp;in a <strong>KML</strong> file to add markers for the DBA locations to a mapping program* &nbsp;<br /> 4 Choose to see the locations on a <strong>Map</strong>&amp;nbsp<br /> 5 <strong>Add</strong> a new entry<br /><strong></strong></p>
...
\n<b>To Contribute to the Guide</b>\nPlease assist us in keeping the guide relevant and useful by proposing any additions or amendments you come across on your cruise. GPS positions (in decimal degrees if possible) would be particularly welcome to enable more locations to be displayed on the guide maps.
\nThis is best done on-line as follows: 
...
\nOn completion click 'Send' - your contribution will be on its way to our editor.
\nIf you are unable to get on line but have some updates, send a simple text email to the editor at guideseditor@barges.org identifying the waterway and name and PK number of the location and describing your proposed change. This is most useful for minor or urgent amendments sent whilst cruising.
";*/
...
Telephone credit or debit card orders can be made to +44 (0) 3036 660 636<br />
<b>For two items or more call for p&p prices or email bookshop@barges.org</b><br />
Buying books and insignia through the DBA supports your Association";
...
$ddformpath="http://www.barges.org/File/media/175_DDIForm.pdf";
...
/*$dbcnx = @mysql_connect("mysql-1.db.vi.net","bargesor","daf475");
if (!$dbcnx) {
  echo( "<P>Unable to connect to the database server at this time.</P>" );
  exit();  
}
mysql_select_db("bargesor") or die ("Can't open database" ); 

//$dbname="bargesor_joodba"; EUK Hosts
...
//updated db opn for php 5 20140420 CJG
//$mysqli = new mysqli("localhost", "barges53_joodba", "S35P6qt1yl", "world");
