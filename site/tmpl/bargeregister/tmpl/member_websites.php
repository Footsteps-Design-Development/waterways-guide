...
To list all entries, leave all fields as 'Any' and leave the 'Search text' box blank then click either search button.";
	...
	echo("<h3>Member websites and blogs</h3>\n");
	...
	if ($assetaction=="list") {
		...
		$filter.="<div class=\"row-fluid\"><div class=\"span6\"><b>Search</b><br><input type=\"button\" class=\"btn btn-primary button_action\" name=\"list_1\" value=\"Whose barge?\" onClick=\"document.form.assetaction.value='list_1';document.form.submit()\">";		
		...
		if ($assetaction!=""){
			...
			if (empty($assets)){
				...
				foreach($assets as $row) {
					...
					$my_secs=strtotime($row["AssetLastUpdate"]);
