<script type="text/javascript">
	...
	var curWaterway = "";
	var curCountry = "";
	var startLat = "47.6392"; // Initially France, adjust based on markers
	var firstlat = "0";
	...
	console.log("/components/com_waterways_guide/tmpl/wwg/guides_map_xml.php" + mapVars);

	downloadUrl("/components/com_waterways_guide/tmpl/wwg/guides_map_xml.php" + mapVars, function(data) {
		console.log(data); // Log the data to inspect the response
	var waterwaysummary = [];

	var xml = data.responseXML;
	console.log(xml); // Log the XML response to see if markers are being returned
	...
	var thislng = parseFloat(markerElem.getAttribute('Lng'));
		...
		// store first valid point for start map center
		startLat = thislat;
	startLng = thislng;
	firstlat = startLat;
                    }
